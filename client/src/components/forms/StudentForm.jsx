...
export default function StudentForm({
  ...
  const [loadingStudent, setLoadingStudent] = useState(mode === "edit");
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 p-4 md:p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <PageHeader
          backTo={"/students"}
          icon={FaUserGraduate}
          title={mode === "edit" ? "Editar Aluno" : "Cadastrar Aluno"}
          subtitle={
            mode === "edit"
        ...
        {loadingStudent ? (
          <div className="space-y-6">
            ...
            {/* Dados Pessoais */}
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200 p-8 space-y-6">
              {/* Nome */}
          ...
          >
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200">
              ...
              <div className="p-8 space-y-8">
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-gray-500">
                        Matrícula única do aluno no sistema
                      </p>
                    </div>
                  </div>
                </div>
                ...
                {/* Seção: Turmas */}
                {(!loading && isAuthenticated && isCoordinator) ||
                mode === "create" ? (
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-4 bg-gray-50 rounded-xl border border-gray-200">
                    <label className="flex items-center space-x-3 cursor-pointer group">
                      ...
                      <div
                        className={`px-3 py-1 rounded-full text-sm font-medium ${form.isActive ? "bg-green-100 text-green-800" : "bg-gray-100 text-gray-800"}`}
                      >
                ...
                <div className="pt-8 border-t border-gray-200">
                  <div className="flex flex-col sm:flex-row gap-4">
                    ...
                    <button
                      type="submit"
                      disabled={submitting}
                      className={`flex-1 px-6 py-3.5 rounded-lg font-medium transition-all flex items-center justify-center space-x-2 ${
                        submitting
